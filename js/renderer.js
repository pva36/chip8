...
class Renderer {
    ...
    renderDisplay(twoDimArray) {
        ...
        for (let x = 0, xCanvas = 0; xCanvas < xLength * this.scale && x < xLength; xCanvas += this.scale, x++) {
            for (let y = 0, yCanvas = 0; yCanvas < yLength * this.scale && y < yLength; yCanvas += this.scale, y++) {
